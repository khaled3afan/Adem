                        ...
                        <div class="cpForm">
                            <form id="add_page">
                                <div class="form-group">
                                    <input type="text" class="form-control" name="p_title" placeholder="عنوان الصفحة ." id="p_title"/>
                                </div>
                                <div class="form-group">
                                    <textarea class="textEditor form-control" name="p_content" placeholder="محتوى الصفحة" rows="10" id="p_content"></textarea>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="p_des" placeholder="وصف الصفحة " id="p_des"/>
                                    <span class="note">من أجل محركات البحث  ، إن ترك فارغًا فسيتم اقتصاص جزء من محتوى الصفحة كوصف لها ، يفضل ألا يتجاوز 200 حرف .</span>
                                </div>
                                <div class="form-group">
                                    <input type="text" class="form-control" name="p_key" placeholder="الكلمات المفتاحية لـ الصفحة " id="p_key"/>
                                    <span class="note">من أجل محركات البحث ، افصل بين كل كلمة وأخرى بـ ( , ) .</span>
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <input class="form-control" name="p_url" dir="ltr" placeholder="رابط الصفحة * اختياري" id="p_url"/>
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="note">الافتراضي : لا .</span>
                                </div>
