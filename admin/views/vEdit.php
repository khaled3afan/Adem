...
<div class="admin_body">
    <ul class="nav nav-tabs">
        <li><a href="<?php _e(SITE_URL)?>/?page=cp">أهلًا!</a></li>
        <li class="active"><a href="<?php _e(SITE_URL)?>/?page=cp&cp=edit">بيانات الواجهة</a></li>
                    ...
                    <div class="editContent">
                        ...
                        <div class="cpForm">
                            <form id="addNew-Form">
                                ...
                                <div class="form-group">
                                    <textarea class="form-control" name="newIContent" placeholder="محتوى الحقل" rows="10" id="newIContent"></textarea>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="cpForm">
                            ...
                            <form id="updatesForm">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="upContent" id="up_infoContent" rows="10"></textarea>
                                </div>
                                <hr/>
